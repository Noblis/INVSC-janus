...
{
    if ((argc < 9) || (argc > 10)) {
        printf("Usage: janus_evaluate sdk_path temp_path target_gallery query_gallery target_metadata query_metadata simmat mask [algorithm]\n");
        return 1;
    }
    ...
    JANUS_ASSERT(janus_evaluate(argv[3], argv[4], argv[5], argv[6], argv[7], argv[8]))
